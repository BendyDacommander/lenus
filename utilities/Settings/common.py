...
def setTitle(_str):
    system = os.name
    if system == 'nt':
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str}Lenus")
    elif system == 'posix':
        sys.stdout.write(f"{_str}Lenus")
    else:
        pass
...
System.Size(120, 30)
System.Clear()
Anime.Fade(Center.Center(gang), Colors.red_to_blue, Colorate.Vertical, interval=0.030, enter=True)
